...
[![CDN](https://img.shields.io/badge/jsDelivr-CDN-orange)](https://cdn.jsdelivr.net/gh/wxkingstar/ai-output-runtime@v0.4.1/assets/ai-output-runtime.js)
...
```bash
curl -s https://cdn.jsdelivr.net/gh/wxkingstar/ai-output-runtime@v0.4.1/assets/ai-output-runtime.js \
